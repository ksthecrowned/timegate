              ...
              >
                <div className="p-1 space-y-0.5">
                  {mailTo && (
                    ...
                    >
                      <i className="fa-solid fa-envelope-open-text shrink-0 size-4" /> Envoyer un mail
                    </a>
                  )}
                  {editHref && (
                    <Link
                  ...
                  {onToggleStatus !== undefined && (
                    <button
                      onClick={() => { setConfirmType('toggle'); setOpen(true); closeMenu() }}
                ...
                {onDelete && (
                  <div className="p-1">
                    <button
                      onClick={() => { setConfirmType('delete'); setOpen(true); closeMenu() }}
