...
export default function HolidayCalendar({
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          <button
            ...
            className="py-2 px-3 inline-flex items-center rounded-lg border border-gray-200 bg-white text-sm text-gray-700 hover:bg-gray-50 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-200 dark:hover:bg-neutral-800"
          ...
          <button
            ...
            className="py-2 px-3 text-sm rounded-lg border border-gray-200 bg-white text-gray-600 hover:bg-gray-50 dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800"
          >
            Aujourd&apos;hui
          </button>
        </div>
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-4 md:p-6 shadow-xs dark:bg-neutral-900 dark:border-neutral-700">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-4">
          {MONTH_NAMES.map((monthName, monthIndex) => (
            <div
              key={monthName}
              className="rounded-lg border border-gray-100 bg-gray-50/60 p-3 dark:border-neutral-800 dark:bg-neutral-800/40"
            >
      ...
      <div className="rounded-xl border border-gray-200 bg-white shadow-xs dark:bg-neutral-900 dark:border-neutral-700">
