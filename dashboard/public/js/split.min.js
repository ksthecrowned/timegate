...
!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(t)
    : ((e = "undefined" != typeof globalThis ? globalThis : e || self).Split =
        t());
})(this, function () {
  "use strict";
  ...
  return function (r, s) {
    ...
    function H(e) {
      ...
      (t.size = (e / this.size) * i),
        ...
        R(t.element, t.size, this._b, t.i),
        R(n.element, n.size, this._c, n.i);
    }
    function I(e) {
      var t,
        n = p[this.a],
        r = p[this.b];
      this.dragging &&
        ((t = q(e) - this.start + (this._b - this.dragOffset)),
        U > 1 && (t = Math.round(t / U) * U),
        t <= n.minSize + n.snapOffset + this._b
          ? (t = n.minSize + this._b)
          : t >= this.size - (r.minSize + r.snapOffset + this._c) &&
            (t = this.size - (r.minSize + this._c)),
        t >= n.maxSize - n.snapOffset + this._b
          ? (t = n.maxSize + this._b)
          : t <= this.size - (r.maxSize - r.snapOffset + this._c) &&
            (t = this.size - (r.maxSize + this._c)),
        H.call(this, t),
        a(s, "onDrag", i)(N()));
    }
    function W() {
      ...
      (this.size = n[f] + i[f] + this._b + this._c),
        (this.start = n[v]),
        (this.end = n[m]);
    }
    function X(e) {
    ...
    function Y() {
      var t = p[this.a].element,
        r = p[this.b].element;
      this.dragging && a(s, "onDragEnd", i)(N()),
        (this.dragging = !1),
    ...
    function G(t) {
      if (!("button" in t) || 0 === t.button) {
        var r = p[this.a].element,
          o = p[this.b].element;
        this.dragging || a(s, "onDragStart", i)(N()),
          t.preventDefault(),
          (this.dragging = !0),
          (this.move = I.bind(this)),
          (this.stop = Y.bind(this)),
          ...
          (this.gutter.style.cursor = B),
          (this.parent.style.cursor = B),
          (n.body.style.cursor = B),
          W.call(this),
          (this.dragOffset = q(t) - this.end);
      }
    }
    "horizontal" === D
      ? ((f = "width"),
    ...
    return (
      (p = y.map(function (e, t) {
        ...
        if (
          t > 0 &&
          (((n = { a: t - 1, b: t, dragging: !1, direction: D, parent: z })._b =
            u(A, t - 1 == 0, !1, k)),
          (n._c = u(A, !1, t === y.length - 1, k)),
        ...
        return (
          R(i.element, i.size, u(A, 0 === t, t === y.length - 1, k), t),
          t > 0 && J.push(n),
          i
        );
      })).forEach(function (e) {
        ...
        setSizes: function (e) {
          ...
          t.forEach(function (e, n) {
            if (n > 0) {
              ...
              (r.size = t[n - 1]),
                (s.size = e),
                R(r.element, r.size, i._b, r.i),
                R(s.element, s.size, i._c, s.i);
            }
          });
        },
        getSizes: N,
